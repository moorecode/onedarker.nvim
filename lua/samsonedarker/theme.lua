...
theme.set_highlights = function()
  ...
  hl(0, "Conditional", { fg = c.purple, bg = c.blue_bg, italic = italic_conditionals })
  hl(0, "Repeat", { fg = c.purple, bg = c.purple_bg, italic = italic_loops })
  hl(0, "Operator", { fg = c.purple, bg = c.purple_bg })

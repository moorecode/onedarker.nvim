...
theme.set_highlights = function()
  ...
  -- Code
  hl(0, "Comment", { fg = c.gray, bg = c.comment_grey_bg, italic = italic_comments })
  ...
  hl(0, "Function", { fg = c.blue, bg = c.blue_bg, italic = italic_functions })
  hl(0, "Keyword", { fg = c.purple, bg = "NONE", italic = italic_keywords })
  hl(0, "Conditional", { fg = c.yellow, bg = c.blue_bg, italic = italic_conditionals })
  hl(0, "Repeat", { fg = c.yellow, bg = c.purple_bg, italic = italic_loops })
  hl(0, "Operator", { fg = c.alt_fg, bg = c.purple_bg })
  ...
  hl(0, "Structure", { fg = c.cyan, bg = c.purple_bg })
